            ...
            ? {
                cardOverride: {
                  ...
                  cardData: {
                    ...
                    printingKind: selectedPrintCard.printingKind,
                    sanctionedPlayLegal: selectedPrintCard.sanctionedPlayLegal,
                    originalPrintingKey: selectedPrintCard.originalPrintingKey,
