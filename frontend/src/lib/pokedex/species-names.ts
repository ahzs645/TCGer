/**
 * National Pokédex order (1–1025).
 *
 * The order is factual species data sourced from PokéAPI. Keeping this compact
 * list in the client lets older offline catalog packs—created before
 * `dexEntries` was included—still group card names by species. Newer packs use
 * their explicit dex entries and never depend on name matching.
 */
export const NATIONAL_POKEDEX_NAMES = [
  ...
  "Spewpa", "Vivillon", "Litleo", "Pyroar", "Flabébé", "Floette", "Florges", "Skiddo",
  ...
  "Sirfetch’d", "Mr. Rime", "Runerigus", "Milcery", "Alcremie", "Falinks", "Pincurchin", "Snom",
