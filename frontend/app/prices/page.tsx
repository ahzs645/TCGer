...
export default function PricesPage() {
  ...
  return (
    <AppShell data-oid="d-50:47">
      <div className="space-y-6" data-oid="y:9uyjz">
        <div data-oid="etsr5_1">
          <h1
          ...
          <p className="text-sm text-muted-foreground" data-oid="jgfj6_z">
        ...
        <div
          ...
          data-oid="zat85a1"
        >
          <Card data-oid="-dwl0pm">
            <CardHeader className="p-3 pb-1 md:p-6 md:pb-4" data-oid="6s9c-z0">
              <CardTitle
            ...
            <CardContent className="p-3 pt-0 md:p-6 md:pt-0" data-oid="fpvroxy">
              <div
          ...
          <Card data-oid="6u:jgvj">
            <CardHeader className="p-3 pb-1 md:p-6 md:pb-4" data-oid="8_l9_qd">
              <CardTitle
                className="text-xs md:text-sm font-medium text-muted-foreground"
                data-oid="ermw6zu"
              >
            ...
            <CardContent className="p-3 pt-0 md:p-6 md:pt-0" data-oid="bfp_g06">
              <div
                className="text-xl md:text-3xl font-semibold"
                data-oid="ivptapc"
              >
          ...
          <Card data-oid="jc.83h5">
            <CardHeader className="p-3 pb-1 md:p-6 md:pb-4" data-oid="egls-d6">
              <CardTitle
                className="text-xs md:text-sm font-medium text-muted-foreground"
                data-oid="-c43.yw"
              >
            ...
            <CardContent className="p-3 pt-0 md:p-6 md:pt-0" data-oid="jv7ch4i">
              <div
          ...
          <Card data-oid="g6grnmz">
            <CardHeader className="p-3 pb-1 md:p-6 md:pb-4" data-oid="r3va297">
              <CardTitle
                className="text-xs md:text-sm font-medium text-muted-foreground"
                data-oid="k2ghk8v"
              >
            ...
            <CardContent className="p-3 pt-0 md:p-6 md:pt-0" data-oid="8uwu54q">
              <div
              ...
              <p className="text-xs text-muted-foreground" data-oid="pt.l364">
        ...
        {/* Search */}
        <div className="relative max-w-sm" data-oid="uf2tssi">
          <Search
        ...
        {/* Price table */}
        <Card data-oid="6zdlj9:">
          <CardContent className="p-0" data-oid="acs..00">
            <div className="overflow-x-auto" data-oid="xhmc:xn">
              <table className="w-full text-sm" data-oid="5is2s2i">
                <thead data-oid="r55ubk8">
                  <tr className="border-b bg-muted/50" data-oid="rr0cfwg">
                    <th
                    ...
                    >
                      ...
                      >
                        Price{" "}
                        <ArrowUpDown className="h-3 w-3" data-oid="at9vvpe" />
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      >
                        7d{" "}
                        <ArrowUpDown className="h-3 w-3" data-oid="1_s7wkc" />
                      </span>
                    </th>
                    <th
                      className="p-3 text-right font-medium text-muted-foreground cursor-pointer select-none"
                    ...
                    >
                      ...
                      >
                        30d{" "}
                        <ArrowUpDown className="h-3 w-3" data-oid="kon2aai" />
                      </span>
                    </th>
                  </tr>
                </thead>
                <tbody data-oid="spej_d-">
                  {filtered.map((p) => (
                    <tr
                      key={p.name}
                      ...
                      data-oid="nm8azds"
                    >
                      <td className="p-3" data-oid="rt48l8d">
                        <span className="font-medium" data-oid="oi1:7b4">
                          {p.name}
                        </span>
                        <span
                      ...
                      <td className="p-3" data-oid="7z2w5xg">
                        <Badge
                          variant="outline"
                          className="text-xs"
                      ...
                      <td className="p-3 text-right" data-oid="c.3es98">
                        <span
                          className={
