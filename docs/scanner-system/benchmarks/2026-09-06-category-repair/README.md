...
- **Policy** `training-minimums-v4` (`tools/card-geometry/policies/training-minimums-v4.json`, SHA-256 `31c7649e571bfaeba23aab77ca1305cca40df7765a92c309d2bbc71a0d0505a7`): identical count minimums to v3 plus `requireTargetSemantics: true`. v3 is unchanged. The combiner accepts v4 under the v3 assembly contract. The successor corpus should bind v4.
